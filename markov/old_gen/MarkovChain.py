...
source_location = os.path.expanduser(
    "~/Documents/programming/coffee_markov_py/markov/12-13-2015_Singlethread_Ex/markov_source.txt")

#CoffeeMarkov = MarkovChain(source_location)

CoffeeMarkov = MarkovChain("markov_source.txt")

#getattr(CoffeeMarkov, generateDatabase)("This is a string of Text. It won't generate an interesting database though.")

#getattr(CoffeeMarkov, generateString)()

CoffeeMarkov.generateString()
